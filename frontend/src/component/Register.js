        ...
        <div className="bg-white p-3 rounded w-30">
            ...
            <form onSubmit={handlesubmit}>
                <div className='mb-3'>
                    ...
                    <input type='text' placeholder='Enter The Name' className='form-control rounded-0' autoComplete='off'
                    name="name" onChange={(e) => setName(e.target.value)} ></input>
                </div>
                ...
                <Link className='btn btn-default border w-100 bg-light ronded-0 text decoration-none'to="/login">Login</Link>
        </div>
    </div>
